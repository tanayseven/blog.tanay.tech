...
<img src="/post/gifs/password-manager.gif" alt="Password Manager" style={{width: '500px'}} className="center" />
...
<img src="/post/gifs/trust-no-one-password.gif" alt="Trust no one" style={{width: '500px'}} className="center" />
...
<img src="/post/gifs/monkey-typing.gif" alt="Monkey typing" style={{width: '500px'}} className="center" />
